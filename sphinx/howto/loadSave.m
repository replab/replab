...
%
% - [replab.Irreducible](../api/rep.rst#+replab.Irreducible) implements [import](../api/rep.rst#+replab.Irreducible.import) and [export](../api/rep.rst#+replab.Irreducible.export). Their usage is documented below.
%
