...
Group can have group actions (`.Action`),  abstract base class that defines the action of elements of a group ``G`` on elements of a domain ``P``,

Morphisms between groups can be tested (`.GroupMorphismLaws`).
...
.. autoclass:: ActionLaws

GroupMorphismLaws
+++++++++++++++++

.. autoclass:: GroupMorphismLaws
