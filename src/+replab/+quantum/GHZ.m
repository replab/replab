classdef GHZ < replab.prods.SemidirectProductGroup_compact
% Symmetry group of the GHZ states
    ...
    methods
        ...
        %   double matrix: Unitary matrix representing ``g``
            ...
            H2 = self.H.factor(2);
            nL = self.nLevels;
            partyRho = replab.Permutation.toMatrix(H1.indexRelabelingPermutation(h1, nL));
            levelMat = replab.Permutation.toMatrix(h2);
            levelRho = 1;
