function irreps = absoluteSplitInParent_complex_unitary(sub, iterator)
% Decomposes fully a complex unitary subrepresentation into irreducible subrepresentations
%
% Args:
