function P = secondProjection(rep, irrep, alpha, beta)
% Computes the projector P_{\alpha\beta} for a given explicit form of an irreducible representation
%
...
s = zeros(rd, rd);    
        for i = 1:length(elements)
            ...
            P{alpha, beta} = s * id / double(G.order); % returns the projection map
end