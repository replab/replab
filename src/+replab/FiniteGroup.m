...
%
% A finite group is generated by a finite set of `.generators`, which have default names
% For display purposes (including the form of the words given by the factorization methods), these generators have names `.generatorNames`.
% However, groups that differ only by the names of their generators are equal.
    ...
    methods
        ...
        %   order (vpi or integer): Group order
            ...
            args = struct('generatorNames', {cell(1, 0)}, 'order', {0});
    ...
    methods (Access = protected)
        ...
        % See `.relators`
            ...
            R = cellfun(@(w) replab.fp.Letters.print(fliplr(w), self.generatorNames), R, 'uniform', 0);
        end
    ...
    methods % Group elements
        ...
        function w = factorizeWord(self, element)
        ...
        function w = lettersToWord(self, letters)
        ...
        function l = wordToLetters(self, word)
