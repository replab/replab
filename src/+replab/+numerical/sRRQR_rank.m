...
% Strong Rank Revealing QR with fixed rank
%
% Its outputs ``Q``, ``R`` and ``p`` such that:
%
% ::
%   A(:, p) = [Q1, Q2] * [R11, R12;
%                           0, R22]
...
%
% The algorithm 4 from the following reference is implemented:
...
%
% Args:
%   A (double(\*,\*)): Target matrix to be approximated
%   f (double): Constant bounding the entries of ``inv(R11) * R12``
%   k (integer): Rank, dimension of R11
%
%
% Returns
% -------
%   Q: double(\*,\*)
%     Part of truncated QR decomposition
%   R: double(\*,\*)
%     Part of truncated QR decomposition
%   p: integer(1,\*)
%     Permutation
