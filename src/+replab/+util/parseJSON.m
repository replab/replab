...
% Parses a JSON string and returns a cell array with the parsed data
%
% JSON objects are converted to structures and JSON arrays are converted to cell arrays.
%
% We removed the use of globals and renamed the function , but otherwise the code is lifted verbatim from
% `<https://www.mathworks.com/matlabcentral/fileexchange/25713-highly-portable-json-input-parser>`_
%
%     based on work from:
%
