function elt_arr = SimpleDimino_fast(generators, order, group)
...
%   order (integer): expected order of group
...
% Example:
% S3 = replab.S(3)
% replab.SimpleDimino({[2,3,1],[2,1,3]}, 6, S3) returns all elements in the 
...
if vec
    elt_arr = mat2cell(elements, ones(1, order));
elseif mat
    elt_arr = mat2cell(elements, ones(1, order));
