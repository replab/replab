            ...
            if ~self.inPath
                ...
                if ~self.inExternal
                    ...
                    elseif exist(fullfile(replabPath, '.git')) == 7
                        ...
                        error(['Dependency %s not present. Please run' char(10) char(10) 'replab_init autoinstall' char(10) char(10) 'if you have Internet access, or follow installation instructions.'], self.name)
                    end
                end
