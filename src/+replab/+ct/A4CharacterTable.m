function ct = A4CharacterTable
    ...
    chars = replab.cyclotomic.fromStrings({'1' '1' '1' '1'; '1' '1' 'E(3)^2' 'E(3)'; '1' '1' 'E(3)' 'E(3)^2'; '3' '-1' '0' '0'});
    ...
    images2 = cellfun(@(s) replab.cyclotomic.fromStrings(s), {{'E(3)'} {'E(3)^2'}}, 'uniform', 0);
    images3 = cellfun(@(s) replab.cyclotomic.fromStrings(s), {{'E(3)^2'} {'E(3)'}}, 'uniform', 0);
