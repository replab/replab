...
%
%    maxRows: maximum row size; optional parameter with default value given in Parameters.m
% maxColumns: maximum column size; optional parameter with default value given in Parameters.m
    if nargin < 3
